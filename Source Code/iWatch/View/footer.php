<!-- Đây là phần footer -->
		<div class="footer-wrapper">
			...
			<!-- Hết phần intro-footer -->
			
			<!-- Đây là phần top-footer -->
			<div class="container top-footer">
				<div class="row">
					<div class="col-sm-3 block-1">
						<!-- Phần div.logo -->
						<div class="logo">
							<p><span>iWATCH</span>SHOP</p>
						</div>
						<!-- Hết Phần div.logo -->
						<!-- Phần div.about-us -->
						<div class="about-us">
							<div class="store">
								<b>Store 1:</b><span> 750 Nguyen Kiem Street, Phu Nhuan District, Ho Chi Minh City</span>
							</div>
							<div class="store">
								<b>Store 2:</b><span> 935 CMT8 Street, Binh Thanh District, Ho Chi Minh City</span>
							</div>
							<div class="store">
								<b>Store 3:</b><span> 1030 3/2 Street, District 3, Ho Chi Minh City</span>
							</div>
							<div class="email">
								<i class="fas fa-envelope"></i> <b>cskh@iwatches.com</b>
							</div>
							<div class="hotline">
								<i class="fas fa-mobile"></i> <b>1900 989913</b>
							</div>
						</div>
						<!-- Hết Phần div.about-us -->
					</div>
					<!-- Hêt block-1 -->
					<div class="col-sm-2 block-2">
						<div class="title">
							<h6>Product</h6>
						</div>
						<div class="product">
							<a href="men_watch.php">Men's Watch</a>
							<a href="lady_watch.php">Ladies's Watch</a>
							<a href="#">accessories</a>
						</div>
					</div>
					<!-- Hết Block-2 -->
					<div class="col-sm-2 block-3">
						<div class="title">
					...
					<!-- Hết Block-4 -->
					<div class="col-sm-3 block-5">
						<div class="title">
							<h6>SIGN UP FOR OUR NEWSLETTER</h6>
						</div>
						<div class="content">
							<p>Sign up to update the latest news and offers from iWatches.</p>
						</div>
						<div class="subscribe">
							<form action="">
